...
class RealTimePlot(Callback):
    def __init__(self):
        ...
        self.ax_loss.set_title("Evolution loss")
        self.ax_acc.set_title("Evolution accuracy")
        self.loss_values = []
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        self.ax_loss.plot(range(self.epoch_count), self.loss_values, label="Train loss")
        self.ax_loss.plot(range(self.epoch_count), self.val_loss_values, label="Test loss")
        self.ax_loss.set_title("Evolution loss")
        self.ax_loss.legend()

        self.ax_acc.plot(range(self.epoch_count), self.acc_values, label="Train accuracy")
        self.ax_acc.plot(range(self.epoch_count), self.val_acc_values, label="Test accuracy")
        self.ax_acc.set_title("Evolution accuracy")
        self.ax_acc.legend()
